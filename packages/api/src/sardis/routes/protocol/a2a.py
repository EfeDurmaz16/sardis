...
from sardis.kill_switch_dep import require_kill_switch_clear
from sardis.middleware.agent_payment_rate_limit import enforce_agent_payment_rate_limit
from sardis.operational_alerts import alert_payment_failure
from sardis.payment_logger import log_payment_event
from sardis.transaction_cap_dep import enforce_transaction_caps
from sardis.webhook_replay import run_with_replay_protection
...
async def a2a_pay(
    ...
    async def _execute() -> tuple[int, object]:
        ...
        from sardis.domains.compliance import ComplianceAdapter
        from sardis.domains.execution_engine import ExecutionEngineAdapter
        from sardis.domains.ledger_core import LedgerCoreAdapter
        from sardis.domains.policy_engine import PolicyEngineAdapter
