...
from sardis.billing.config import PLAN_LIMITS, PLAN_PRICES_CENTS, BillingConfig
from sardis.billing.models import BillingAccount, PlanInfo, UsageSnapshot
from sardis.billing.polar_adapter import get_billing_provider, get_billing_provider_name
from sardis.services.stripe_billing import PLANS, StripeBillingService
from sardis.services.usage_metering import UsageMeteringService
...
async def create_checkout_session(
    ...
    # --- Polar checkout path ---
    if provider == "polar":
        from sardis.billing.polar_adapter import PolarBillingAdapter
        ...
        try:
            ...
            from sardis.analytics.posthog_tracker import PLAN_UPGRADED, track_event
