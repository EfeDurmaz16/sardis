...
from sardis_server.billing.config import PLAN_LIMITS, PLAN_PRICES_CENTS, BillingConfig
from sardis_server.billing.models import BillingAccount, PlanInfo, UsageSnapshot
from sardis_server.billing.polar_adapter import get_billing_provider, get_billing_provider_name
from sardis_server.services.stripe_billing import PLANS, StripeBillingService
from sardis_server.services.usage_metering import UsageMeteringService
...
async def create_checkout_session(
    ...
    # --- Polar checkout path ---
    if provider == "polar":
        from sardis_server.billing.polar_adapter import PolarBillingAdapter
        ...
        try:
            ...
            from sardis_server.analytics.posthog_tracker import PLAN_UPGRADED, track_event
