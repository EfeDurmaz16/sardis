...
from sardis_server.kill_switch_dep import require_kill_switch_clear_checkout
...
async def confirm_external_payment(
    ...
    from sardis_server.services.onchain_verification import verify_usdc_transfer
