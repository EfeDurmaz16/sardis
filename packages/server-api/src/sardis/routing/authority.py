...
from sardis.routes.authority import ap2, mandates, mvp
from sardis.routes.authority import approval_config as approval_config_router

try:
    from sardis.routes.authority import approvals as approvals_router
except ImportError:
