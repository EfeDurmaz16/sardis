...
from sardis.kill_switch_dep import require_kill_switch_clear_checkout
...
async def get_connect_params(
    ...
    """
    from sardis.services.eip712_checkout import (
...
async def confirm_external_payment(
    ...
    from sardis.services.onchain_verification import verify_usdc_transfer
