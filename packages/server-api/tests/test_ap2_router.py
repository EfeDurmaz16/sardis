...
from sardis.routes.authority.ap2 import PROMPT_INJECTION_PATTERNS
...
class TestAP2RequestValidation:
    ...
    def test_compliance_check_result_defaults(self):
        ...
        from sardis.routes.authority.ap2 import ComplianceCheckResult
    ...
    def test_dependencies_dataclass(self):
        ...
        from sardis.routes.authority.ap2 import Dependencies
...
class TestAP2Helpers:
    ...
    def test_is_truthy_env(self):
        from sardis.routes.authority.ap2 import _is_truthy_env
    ...
    def test_risk_rank_ordering(self):
        from sardis.routes.authority.ap2 import _risk_rank
    ...
    def test_sanctions_risk_level_extracts_value(self):
        from sardis.routes.authority.ap2 import _sanctions_risk_level
