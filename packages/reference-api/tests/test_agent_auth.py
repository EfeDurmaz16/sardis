...
def test_mandate_to_capability_grant():
    ...
    from server.routes.identity.agent_auth import mandate_to_capability_grant
...
def test_capability_grant_to_mandate():
    ...
    from server.routes.identity.agent_auth import capability_grant_to_mandate
...
def test_mandate_roundtrip():
    ...
    from server.routes.identity.agent_auth import (
