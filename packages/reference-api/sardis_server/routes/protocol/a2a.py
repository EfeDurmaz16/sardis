...
from sardis_server.idempotency import get_idempotency_key, run_idempotent
from sardis_server.kill_switch_dep import require_kill_switch_clear
from sardis_server.middleware.agent_payment_rate_limit import enforce_agent_payment_rate_limit
from sardis_server.operational_alerts import alert_payment_failure
from sardis_server.payment_logger import log_payment_event
from sardis_server.transaction_cap_dep import enforce_transaction_caps
from sardis_server.webhook_replay import run_with_replay_protection
...
async def a2a_pay(
    ...
    async def _execute() -> tuple[int, object]:
        ...
        from sardis_server.domains.compliance import ComplianceAdapter
        from sardis_server.domains.execution_engine import ExecutionEngineAdapter
        from sardis_server.domains.ledger_core import LedgerCoreAdapter
        from sardis_server.domains.policy_engine import PolicyEngineAdapter
