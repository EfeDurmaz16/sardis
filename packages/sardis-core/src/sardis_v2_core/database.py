...
CREATE TABLE IF NOT EXISTS wallets (
    ...
    account_type VARCHAR(32) NOT NULL DEFAULT 'mpc_v1',
    currency VARCHAR(10) NOT NULL DEFAULT 'USDC',
    limit_per_tx NUMERIC(20,6) NOT NULL DEFAULT 100,
    limit_total NUMERIC(20,6) NOT NULL DEFAULT 1000,
    addresses JSONB NOT NULL DEFAULT '{}',
    smart_account_address VARCHAR(66),
    entrypoint_address VARCHAR(66),
    paymaster_enabled BOOLEAN NOT NULL DEFAULT FALSE,
    bundler_profile VARCHAR(64),
    is_active BOOLEAN DEFAULT TRUE,
...
CREATE TABLE IF NOT EXISTS settlements (
    ...
    ledger_entries TEXT[] DEFAULT ARRAY[]::TEXT[]
);
