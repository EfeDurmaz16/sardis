...
class ControlPlane:
    ...
    async def submit(self, intent: ExecutionIntent) -> ExecutionResult:
        ...
        .. deprecated::
            Use :class:`~sardis.core.orchestrator.PaymentOrchestrator`
            with :class:`~sardis.core.pre_execution_pipeline.PreExecutionPipeline`
            and the hooks from :mod:`sardis.core.hooks` instead.
        """
        warnings.warn(
