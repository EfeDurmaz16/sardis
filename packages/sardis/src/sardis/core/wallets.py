...
Usage:
    from sardis.core import Wallet, TokenType
...
class Wallet(BaseModel):
    ...
    cdp_wallet_id: str | None = None
    cdp_wallet_address: str | None = None
    cdp_funded_amount: Decimal = Field(default=Decimal("0"))
    x402_enabled: bool = False
    circle_wallet_id: str | None = None
    kya_attestation_uid: str | None = None
    ...
    async def sign_transaction(
        ...
        tx_request: TransactionRequest | None = None,
    ) -> str:
        """
    ...
    def get_limit_per_tx(self, token: TokenType | None = None) -> Decimal:
    ...
    def get_limit_total(self, token: TokenType | None = None) -> Decimal:
