...
from sardis.protocol.x402 import X402_SUPPORTED_VERSIONS, validate_x402_version
...
def test_all_protocols_have_version_constants():
    ...
    from sardis.protocol.schemas import AP2_PROTOCOL_VERSION, AP2_SUPPORTED_VERSIONS
    ...
    from sardis.protocol.x402 import X402_VERSION_1, X402_VERSION_2
