"""
Comprehensive tests for sardis.core.logging module.
...
from sardis.core.logging import (
    JsonFormatter,
    RequestContext,
    StructuredLogger,
    # Configuration
...
class TestMaskSensitiveData:
    ...
    def test_mask_dict_with_sensitive_keys(self):
        ...
        data = {
            "username": "john",
            "password": "secret123",
            "api_key": "sk_live_abc123",  # nosecret (test fixture)
        }
    ...
    def test_mask_inline_api_keys(self):
        ...
        data = {"message": "Using key sk_live_abc123def456"}  # nosecret (test fixture)
        result = mask_sensitive_data(data)
    ...
    def test_mask_jwt_tokens(self):
        ...
        jwt = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c"  # nosecret (canonical jwt.io example)
        data = {"token": jwt}
        result = mask_sensitive_data(data)
...
class TestLoggingSecurityEdgeCases:
    ...
    def test_truncates_long_messages(self):
        ...
        from sardis.core.logging import _mask_inline_patterns
