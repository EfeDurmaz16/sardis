...
from sardis_api.routers.onramp import router
from sardis_api.services.conduit_onramp import (
    API_VERSION,
    PRODUCTION_BASE_URL,
    SANDBOX_BASE_URL,
    SUPPORTED_ASSETS,
...
class TestWalletFundConduitEndpoint:
    ...
    def test_fund_conduit_requires_amount(self, monkeypatch):
        ...
        with patch(
            "sardis_api.routers.onramp._get_conduit_onramp_service",
...
class TestExistingTurnkeyEndpointsStillWork:
    ...
    def test_fund_coinbase_still_works(self, monkeypatch):
        ...
        from sardis_api.services.turnkey_onramp import OnrampSession
        ...
        with patch(
            "sardis_api.routers.onramp._get_turnkey_onramp_service",
