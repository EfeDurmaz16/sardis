...
class TestEmergencyFreezeModels:
    ...
    def test_freeze_all_request_defaults(self):
        from sardis_server.routes.operations.emergency import FreezeAllRequest
        req = FreezeAllRequest()
        assert req.reason == "manual_emergency"
        assert req.notes is None

    def test_freeze_all_response_fields(self):
        from sardis_server.routes.operations.emergency import FreezeAllResponse
    ...
    def test_emergency_status_response(self):
        from sardis_server.routes.operations.emergency import EmergencyStatusResponse
...
class TestEmergencyFreezeLogic:
    ...
    async def test_freeze_all_updates_wallets(self):
        ...
        with patch("sardis_server.routes.operations.emergency.log_admin_action", new_callable=AsyncMock):
            with patch("sardis_v2_core.database.Database.get_pool", return_value=mock_pool):
                from sardis_server.routes.operations.emergency import FreezeAllRequest, freeze_all_wallets
...
class TestEmergencyFreezeRouter:
    ...
    def test_router_has_correct_prefix(self):
        from sardis_server.routes.operations.emergency import router
