...
class TestStripeSPTAdapterExecute:
    ...
    async def test_execute_stripe_api_error(self):
        ...
        adapter = StripeSPTAdapter(api_key="sk_test_fake_000000"  # nosecret, encryption=enc)
    ...
    async def test_execute_decryption_failure(self):
        ...
        adapter = StripeSPTAdapter(api_key="sk_test_fake_000000"  # nosecret, encryption=enc_b)
        request = _make_request()
...
def _build_spt_test_app(webhook_secret: str) -> TestClient:
    ...
    from server.routes.providers.stripe_spt_webhooks import router
