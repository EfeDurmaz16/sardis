const stats = [
  {
    number: "50K+",
    label: "SDK Installs",
    meta: "50,000+ downloads on PyPI and npm",
  },
  {
    number: "52",
    label: "MCP Tools",
    meta: "52 tools for Claude Desktop integration",
  },
  {
    number: "12",
    label: "Policy Checks",
    meta: "12-check enforcement pipeline on every transaction",
  },
  {
    number: "6",
...
export default function StatsSection() {
  return (
    <div className="max-w-[1440px] mx-auto px-5 md:px-12 xl:px-20 py-20 md:py-28 flex flex-col items-center gap-0">
      <div
        className="max-w-7xl w-full h-px"
