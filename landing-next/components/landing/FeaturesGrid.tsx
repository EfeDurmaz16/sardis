    ...
    >
      <div className="max-w-[1440px] mx-auto px-5 md:px-12 xl:px-20 pt-[100px] md:pt-[140px]">
        <div className="flex flex-col gap-4 mb-10">
          ...
          >
            Natural language policies, kill switches, approval workflows, signed
            attestation envelopes, simulation, and anomaly detection -- routed
            through a single execution gateway, without holding your private
            keys.
          </p>
        </div>
