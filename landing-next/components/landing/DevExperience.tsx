    ...
    <div className="max-w-[1440px] mx-auto px-5 md:px-12 xl:px-20 pt-[100px] md:pt-[140px]">
      <div className="flex flex-col md:flex-row gap-12 md:gap-16 lg:gap-24 items-center">
        ...
        <div className="w-full md:w-auto md:shrink-0 md:max-w-[460px] flex flex-col gap-6">
          ...
          >
            From install to first payment in under a minute. Our Python and
            TypeScript SDKs make agent payments feel native.
          </p>
          ...
          >
            ...
            <button
              onClick={handleCopy}
              className="text-[12px] transition-colors duration-150 shrink-0 min-w-[44px] min-h-[44px] flex items-center justify-center hover:text-[var(--landing-text-primary)]"
              style={{
                fontFamily: "'JetBrains Mono', monospace",
