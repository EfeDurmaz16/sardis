              ...
              {col.links.map((link) =>
                "external" in link && link.external ? (
                  <a
                    ...
                    className="transition-colors mb-2.5 block hover:text-[var(--landing-text-tertiary)]"
                    style={linkStyle}
                  >
                    {link.label}
                  </a>
          ...
          <div className="flex gap-6">
            {[
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[12px] transition-colors hover:text-[var(--landing-text-tertiary)]"
                style={{
                  fontFamily: "'Inter', sans-serif",
                  color: "var(--landing-text-ghost)",
                }}
