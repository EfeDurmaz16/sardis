...
function getStatusColor(status: string) {
  if (status === "Production") return { bg: "rgba(34,197,94,0.1)", color: "#22C55E", border: "rgba(34,197,94,0.15)" };
  if (status === "Pilot") return { bg: "rgba(59,130,246,0.1)", color: "#3B82F6", border: "rgba(59,130,246,0.15)" };
  return { bg: "rgba(161,161,170,0.1)", color: "#A1A1AA", border: "rgba(161,161,170,0.15)" };
}
    ...
    >
      <div className="max-w-[1440px] mx-auto px-5 md:px-12 xl:px-20 pt-[100px] md:pt-[140px]">
        <div className="flex flex-col gap-4 mb-10">
          ...
          >
            Sardis implements and extends the emerging standards for agentic
            commerce. See each protocol&apos;s maturity status below.
          </p>
        </div>
