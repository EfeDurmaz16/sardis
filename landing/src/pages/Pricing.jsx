...
const PLANS = [
  ...
  },
  {
    ...
    ctaTo: 'https://dashboard.sardis.sh/signup?plan=dev',
    features: [
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#050506' }}>
      ...
      >
        ...
        >
          ...
          <Link to="/docs/terms" className="underline" style={{ color: '#505460' }}>
            Terms
          </Link>{' '}
          &middot;{' '}
          <Link to="/docs/privacy" className="underline" style={{ color: '#505460' }}>
            Privacy
          </Link>
        </p>
      </footer>
