  ...
  const partners = [
    {
      name: 'Coinbase',
      svg: (
        <svg viewBox="0 0 200 40" fill="none" className="h-5 md:h-6 w-auto">
    ...
    },
    {
      name: 'Base',
      svg: (
        <svg viewBox="0 0 120 40" fill="none" className="h-5 md:h-6 w-auto">
    ...
    },
    {
      name: 'Circle',
      svg: (
        <svg viewBox="0 0 130 40" fill="none" className="h-5 md:h-6 w-auto">
    ...
    },
    {
      name: 'Anthropic MCP',
      svg: (
        <svg viewBox="0 0 190 40" fill="none" className="h-5 md:h-6 w-auto">
