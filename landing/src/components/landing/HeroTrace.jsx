...
function TraceStep({ step, index, activeIndex }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="px-5 pt-4 pb-2 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div
              ...
              style={{ background: activeIndex >= TRACE_STEPS.length - 1 ? '#22C55E' : '#3B82F6' }}
            />
            <span
              className="text-[11px] font-medium uppercase tracking-wider"
              style={{
                fontFamily: "'JetBrains Mono', monospace",
                color: activeIndex >= TRACE_STEPS.length - 1 ? '#22C55E' : '#808080',
              }}
            >
              {activeIndex >= TRACE_STEPS.length - 1 ? 'Complete' : 'Processing'}
            </span>
          </div>
          <span
            className="text-[10px]"
        ...
        {/* Code snippet */}
        <div className="mx-5 mb-3 rounded-lg px-3 py-2" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.04)' }}>
          <pre
            className="text-[11px] leading-relaxed overflow-hidden"
            style={{ fontFamily: "'JetBrains Mono', monospace", color: '#A0A0AA' }}
          >
        ...
        >
          ...
          <span style={{ color: '#505460', fontSize: 10, fontFamily: "'JetBrains Mono', monospace" }}>
            Base mainnet
          </span>
        </div>
      </div>
