    ...
    questions: [
      {
        ...
        a: 'Use our MCP (Model Context Protocol) server. Run `npx @sardis/mcp-server start` and add it to your claude_desktop_config.json. Claude gets 59 tools including payment, wallet, fiat, checkout, and agent discovery tools.'
      },
      {
        q: 'Which AI frameworks does Sardis support?',
        a: 'Sardis supports: Claude MCP (59 tools), LangChain (Python and JavaScript), OpenAI Function Calling, Vercel AI SDK, and LlamaIndex. Our Python and TypeScript SDKs work with any framework.'
      },
      {
