      ...
      <article className="prose dark:prose-invert max-w-none">
        ...
        <div className="not-prose mt-8 p-6 border border-[var(--sardis-orange)]/30 bg-[var(--sardis-orange)]/5">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>
              → <Link to="/docs/blog/financial-hallucination-prevention" className="text-[var(--sardis-orange)] hover:underline">Financial Hallucination Prevention</Link>
            </li>
            <li>
              → <Link to="/docs/blog/spending-rules-explained" className="text-[var(--sardis-orange)] hover:underline">How AI Agent Spending Rules Actually Work</Link>
            </li>
            <li>
              → <Link to="/docs/security" className="text-[var(--sardis-orange)] hover:underline">Security & Cryptographic Audit Trail</Link>
            </li>
            <li>
