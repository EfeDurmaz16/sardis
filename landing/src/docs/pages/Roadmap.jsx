  ...
  const roadmapData = [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'P1: Mainnet gas profiling and optimization pass with CI gas ceilings', done: true },
        { text: 'P1: Turnkey outage runbook + DR playbook (RTO/RPO + failover mode)', done: true },
        { text: 'Turnkey/Fireblocks UserOperation signing path (production signer support)', done: true },
        { text: 'Base Sepolia full E2E proof artifact with userOp hash and on-chain receipt', done: true },
        { text: 'Base mainnet ERC-4337 rollout with staged sponsor caps', done: true },
        { text: 'Stablecoin-only token allowlist smart contract', done: true },
        { text: 'Recurring payments engine (subscription registry + scheduled billing + auto-fund)', done: true },
