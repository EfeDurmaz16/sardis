    ...
    <article className="prose dark:prose-invert max-w-none">
      ...
      <section className="mb-12">
        ...
        <p className="text-muted-foreground leading-relaxed">
          ...
          <Link href="/docs/ap2" className="text-[var(--sardis-orange)]">AP2</Link>,{' '}
          <Link href="/docs/ucp" className="text-[var(--sardis-orange)]">UCP</Link>, and{' '}
          <Link href="/docs/a2a" className="text-[var(--sardis-orange)]">A2A</Link>, enabling agents
...
└─────────────┘     └───────────┘     └──────────────┘
      ...
      <section className="not-prose p-6 border border-border bg-muted/30">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href="/docs/ap2" className="px-4 py-2 border border-border hover:border-[var(--sardis-orange)] text-sm font-mono transition-colors">AP2 (Payment)</Link>
          <Link href="/docs/ucp" className="px-4 py-2 border border-border hover:border-[var(--sardis-orange)] text-sm font-mono transition-colors">UCP (Commerce)</Link>
          <Link href="/docs/a2a" className="px-4 py-2 border border-border hover:border-[var(--sardis-orange)] text-sm font-mono transition-colors">A2A (Agent-to-Agent)</Link>
          <Link href="/docs/tap" className="px-4 py-2 border border-border hover:border-[var(--sardis-orange)] text-sm font-mono transition-colors">TAP (Trusted Agent)</Link>
        </div>
      </section>
    </article>
  );
