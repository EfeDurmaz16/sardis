...
└─────────────────────────────────────────────────────────────┘`}</pre>
      ...
      <section className="mb-14">
        <div className="not-prose grid gap-5">
          <Link href="/docs/ap2" className="block p-6 bg-card/50 rounded-lg shadow-sm hover:shadow-md hover:bg-card transition-all group">
          ...
          <Link href="/docs/ucp" className="block p-6 bg-card/50 rounded-lg shadow-sm hover:shadow-md hover:bg-card transition-all group">
            <div className="flex items-center gap-4 mb-3">
          ...
          <Link href="/docs/a2a" className="block p-6 bg-card/50 rounded-lg shadow-sm hover:shadow-md hover:bg-card transition-all group">
            <div className="flex items-center gap-4 mb-3">
          ...
          <Link href="/docs/tap" className="block p-6 bg-card/50 rounded-lg shadow-sm hover:shadow-md hover:bg-card transition-all group">
            <div className="flex items-center gap-4 mb-3">
          ...
          <Link href="/docs/acp" className="block p-6 bg-card/50 rounded-lg shadow-sm hover:shadow-md hover:bg-card transition-all group">
            <div className="flex items-center gap-4 mb-3">
              <div className="w-10 h-10 rounded-lg bg-[var(--sardis-orange)]/10 flex items-center justify-center">
