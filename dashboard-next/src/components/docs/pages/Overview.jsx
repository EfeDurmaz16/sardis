    ...
    <article className="prose dark:prose-invert max-w-none">
      ...
      <section className="mb-12">
        ...
        <div className="not-prose grid md:grid-cols-3 gap-4">
          <Link href="/docs/quickstart" className="block p-4 border border-border hover:border-[var(--sardis-orange)] transition-colors group">
          ...
          <Link href="/docs/sdk" className="block p-4 border border-border hover:border-[var(--sardis-orange)] transition-colors group">
          ...
          <Link href="/docs/architecture" className="block p-4 border border-border hover:border-[var(--sardis-orange)] transition-colors group">
