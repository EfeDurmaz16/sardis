      ...
      <article className="prose dark:prose-invert max-w-none">
        ...
        <div className="not-prose mt-10 p-6 bg-card/50 rounded-lg">
          ...
          <div className="text-sm text-muted-foreground">
            See <Link href="/docs/roadmap" className="text-[var(--sardis-orange)] hover:underline">Roadmap</Link> and{' '}
            <Link href="/docs/changelog" className="text-[var(--sardis-orange)] hover:underline">Changelog</Link>.
          </div>
        </div>
      </article>
    </>
