    ...
    <article className="prose dark:prose-invert max-w-none">
      ...
      <div className="not-prose mt-8 p-6 border border-[var(--sardis-orange)]/30 bg-[var(--sardis-orange)]/5">
        ...
        <ul className="space-y-2 text-sm text-muted-foreground">
          <li>
            → <Link href="/docs/changelog" className="text-[var(--sardis-orange)] hover:underline">Full Changelog</Link>
          </li>
          <li>
            → <Link href="/docs/roadmap" className="text-[var(--sardis-orange)] hover:underline">Roadmap</Link>
          </li>
          <li>
