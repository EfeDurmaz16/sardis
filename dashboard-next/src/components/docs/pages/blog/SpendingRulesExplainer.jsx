...
# Your agent can now spend within these exact guardrails`}</pre>
        ...
        <div className="not-prose mt-8 p-6 border border-[var(--sardis-orange)]/30 bg-[var(--sardis-orange)]/5">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li>
              → <Link href="/docs/spending-mandates" className="text-[var(--sardis-orange)] hover:underline">Spending Mandates (Delegated Authority)</Link>
            </li>
            <li>
              → <Link href="/docs/quickstart" className="text-[var(--sardis-orange)] hover:underline">Quickstart Guide</Link>
            </li>
            <li>
              → <Link href="/docs/security" className="text-[var(--sardis-orange)] hover:underline">Security & Audit Trail</Link>
            </li>
          </ul>
        </div>
