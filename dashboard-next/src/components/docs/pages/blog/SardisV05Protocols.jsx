...
await agent.serve()`}
        ...
        <p>
          Read the full <Link href="/docs/ucp" className="text-[var(--sardis-orange)]">UCP documentation</Link> or
          check out the <Link href="/docs/a2a" className="text-[var(--sardis-orange)]">A2A guide</Link> to
          get started.
        </p>
      </div>
