...
export default function SardisV07ProductionHardening() {
  return (
    <article className="prose dark:prose-invert max-w-none">
      ...
      <p>
        If you're building AI agents that need real financial capabilities, <Link href="/docs/quickstart" className="text-[var(--sardis-orange)]">get started with Sardis</Link> today.
      </p>
