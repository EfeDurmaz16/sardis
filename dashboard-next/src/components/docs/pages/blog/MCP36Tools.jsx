  ...
  "mcpServers": {
    "sardis": {
      ...
      "env": {
        ...
        <p>Restart your app, and you now have 52 payment tools available.</p>
...
- Card issuance with merchant lock`}
        ...
        <p>
          Read the full <Link href="/docs/mcp-server" className="text-[var(--sardis-orange)]">MCP Server documentation</Link> for
