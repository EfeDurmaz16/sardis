...
{`wallet = client.wallets.create(
    ...
    """
        ...
        <div className="not-prose bg-[var(--sardis-ink)] dark:bg-[#1a1a1a] p-4 font-mono text-sm mb-6 border border-border">
          ...
          <div className="text-muted-foreground mt-2"># That's it. 52 payment and treasury tools available.</div>
        </div>
        ...
        <p>
          ...
          <Link href="/docs/quickstart" className="text-[var(--sardis-orange)]"> quickstart guide</Link> or
          try the <Link href="/docs/mcp-server" className="text-[var(--sardis-orange)]">MCP server</Link> for
