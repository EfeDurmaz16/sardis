...
const PLANS = [
  {
    ...
    priceLabel: '$49',
    period: '/mo',
    tagline: 'Testnet access for builders.',
    highlighted: false,
    badge: null,
    cta: 'Get Started',
    ctaTo: '/signup?plan=dev',
    features: [
      { label: '1,000 API calls / mo', included: true },
      { label: '2 agents', included: true },
      { label: '100 transactions / mo', included: true },
      { label: 'Testnet only', included: true },
  ...
  },
  {
    ...
    priceLabel: '$199',
    period: '/mo',
    tagline: 'Production-ready for teams shipping fast.',
    highlighted: true,
    badge: 'Most Popular',
    ...
    features: [
      ...
      { label: '25 agents', included: true },
      { label: 'Unlimited transactions', included: true },
      { label: 'Mainnet access', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Unlimited transactions', included: true },
      { label: 'Mainnet + FX swaps', included: true },
      { label: 'Dedicated MPC wallets', included: true },
      { label: 'Priority support', included: true },
      { label: 'KYB + PEP screening', included: true },
      { label: 'Advanced audit trail', included: true },
    ],
  },
  {
    name: 'Enterprise',
    ...
    features: [
      ...
      { label: 'Custom transaction fee', included: true },
      { label: 'Custom volume limits', included: true },
