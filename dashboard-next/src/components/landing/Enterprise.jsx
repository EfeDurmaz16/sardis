    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden font-sans selection:bg-primary/20">
      ...
      >
        <div className="container mx-auto px-6 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 font-bold text-xl tracking-tight font-display">
            <SardisLogo />
            <span>Sardis</span>
          </Link>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
              <div>
                ...
                <ul className="space-y-2 text-muted-foreground">
                  <li><Link href="/docs" className="hover:text-[var(--sardis-orange)] transition-colors">Documentation</Link></li>
                  <li><Link href="/docs/quickstart" className="hover:text-[var(--sardis-orange)] transition-colors">Quick Start</Link></li>
                  <li><Link href="/playground" className="hover:text-[var(--sardis-orange)] transition-colors">Playground</Link></li>
                  <li><Link href="/enterprise" className="hover:text-[var(--sardis-orange)] transition-colors">Enterprise</Link></li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold mb-3 text-foreground">Resources</h4>
                <ul className="space-y-2 text-muted-foreground">
                  <li><Link href="/docs/blog" className="hover:text-[var(--sardis-orange)] transition-colors">Blog</Link></li>
                  <li><Link href="/docs/changelog" className="hover:text-[var(--sardis-orange)] transition-colors">Changelog</Link></li>
                  <li><Link href="/docs/security" className="hover:text-[var(--sardis-orange)] transition-colors">Security</Link></li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold mb-3 text-foreground">Legal</h4>
                <ul className="space-y-2 text-muted-foreground">
                  <li><Link href="/docs/terms" className="hover:text-[var(--sardis-orange)] transition-colors">Terms</Link></li>
                  <li><Link href="/docs/privacy" className="hover:text-[var(--sardis-orange)] transition-colors">Privacy</Link></li>
                </ul>
              </div>
              <div>
