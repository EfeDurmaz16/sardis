...
export default function NotificationCenter() {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger className="relative p-2 text-gray-400 hover:text-white transition-colors">
      ...
      <PopoverContent align="end" className="w-80 p-0 max-h-96 overflow-hidden flex flex-col bg-dark-300 border border-dark-100">
