        ...
        <div className="mb-6 space-y-4">
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => handleCopy("pip install sardis")}
                className="shrink-0 p-2 bg-dark-300 border border-dark-100 rounded-lg text-gray-500 hover:text-white transition-colors"
              >
                {copied ? (
  ...
  return (
    <div>
      ...
      <p className="text-gray-400 mb-8">
        Give your AI agent a name and an optional description so you can identify
        it later.
      </p>
...
function StepSetPolicy({
  ...
  return (
    <div>
      ...
      <p className="text-gray-400 mb-8">
        Describe your agent&apos;s spending rules in plain English. Sardis will
        parse and enforce them automatically.
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <p className="mt-2 text-xs text-gray-600">
            Examples: &quot;Max $100 per transaction&quot;, &quot;Only allow
            payments to approved vendors&quot;, &quot;Block any crypto
            purchases&quot;
          </p>
        </div>
...
function StepTestPayment({
  ...
  return (
    <div>
      ...
      <p className="text-gray-400 mb-8">
        Let&apos;s simulate a $1 test payment to confirm everything is wired up
        correctly.
      </p>
        ...
        <div className="flex items-center gap-3 p-4 bg-green-500/10 border border-green-500/20 rounded-lg mb-6">
          ...
          <div>
            ...
            <p className="text-green-400/70 text-xs mt-0.5">
              Your agent processed the test transaction successfully.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="w-full max-w-lg">
        <div className="bg-gray-900 rounded-2xl border border-dark-100 p-8 shadow-2xl">
          ...
          {currentStep === 1 && (
            <StepWelcome
              onNext={advance}
              onSkip={() => setStepIndex(totalSteps - 1)}
              apiKey={apiKey}
            />
          )}
          {currentStep === 2 && (
