...
export PYTHONPATH="${ROOT_DIR}/packages/sardis-cards/src:${ROOT_DIR}/apps/api:${ROOT_DIR}/packages/sardis-core/src:${ROOT_DIR}/packages/sardis-ledger/src:${ROOT_DIR}/packages/sardis-protocol/src:${PYTHONPATH:-}"
...
python3 -m pytest -q apps/api/tests/test_partner_card_webhooks.py::test_partner_webhook_duplicate_event_is_idempotent
