...
require_match 'policy_pin_requires_active_policy' \
  'packages/api/src/sardis/routers/onchain_payments.py' \
...
require_match 'cursor_scope_mismatch' \
  'packages/api/src/sardis/routers/compliance.py' \
...
require_match 'card_details_invalid' \
  'packages/api/src/sardis/routers/secure_checkout.py' \
...
require_match '_check_a2a_trust_relation' \
  'packages/api/src/sardis/routers/a2a.py' \
...
require_match '/asa/security-policy' \
  'packages/api/src/sardis/routers/cards.py' \
