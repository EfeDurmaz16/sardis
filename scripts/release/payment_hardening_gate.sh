...
require_match 'policy_pin_requires_active_policy' \
  'packages/reference-api/server/routes/wallets/onchain_payments.py' \
...
require_match 'card_details_invalid' \
  'packages/reference-api/server/routes/commerce/secure_checkout.py' \
...
require_match '_check_a2a_trust_relation' \
  'packages/reference-api/server/routes/protocol/a2a.py' \
...
require_match '/asa/security-policy' \
  'packages/reference-api/server/routes/wallets/cards.py' \
