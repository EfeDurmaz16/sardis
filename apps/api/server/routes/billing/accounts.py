...
from server.billing.config import PLAN_LIMITS, PLAN_PRICES_CENTS, BillingConfig
from server.billing.models import BillingAccount, PlanInfo, UsageSnapshot
from server.billing.polar_adapter import get_billing_provider, get_billing_provider_name
from server.services.stripe_billing import PLANS, StripeBillingService
...
async def create_checkout_session(
    ...
    # --- Polar checkout path ---
    if provider == "polar":
        from server.billing.polar_adapter import PolarBillingAdapter
        ...
        try:
            ...
            from server.analytics.posthog_tracker import PLAN_UPGRADED, track_event
