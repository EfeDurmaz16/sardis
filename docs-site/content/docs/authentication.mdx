...
description: Start using Sardis with local simulation, a self-hosted reference API, the CLI, or MCP.
---
...
When you're ready for API-backed flows, continue to option 2 or 3.

## Option 2: Reference API

Use a sandbox API key issued by the Sardis reference API deployment you control. The public repository documents the protocol and developer platform; hosted product onboarding lives outside the OSS source tree.
