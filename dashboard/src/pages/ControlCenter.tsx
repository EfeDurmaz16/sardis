    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-dark-300 border border-dark-100 p-5 flex items-center justify-between">
        ...
        {pendingCount > 0 ? (
          ...
          <CheckCircle className="w-6 h-6 text-sardis-500 opacity-60" />
        )}
      </div>
      ...
      <div className="bg-dark-300 border border-dark-100 p-5 flex items-center justify-between">
        ...
        <Pulse className="w-6 h-6 text-sardis-500 opacity-60" />
      </div>
      ...
      <div className="bg-dark-300 border border-dark-100 p-5 flex items-center justify-between">
        ...
        <TrendDown className="w-6 h-6 text-gray-500 opacity-60" />
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {isError ? (
          ...
          <div className="flex flex-col items-center justify-center py-10 text-gray-500 gap-2">
            <ArrowsClockwise className="w-6 h-6 animate-spin opacity-50" />
...
function RiskFeed({ transactions, isLoading }: RiskFeedProps) {
  ...
  return (
    <div className="bg-dark-300 border border-dark-100 flex flex-col">
      ...
      <div className="flex items-center justify-between px-5 py-4 border-b border-dark-100">
        <div className="flex items-center gap-2">
          <Pulse className="w-4 h-4 text-sardis-400" />
      ...
      <div className="flex-1 overflow-y-auto">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-10 text-gray-500 gap-2">
            <Lightning className="w-8 h-8 opacity-30" />
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              >
                {deniedToday}
                {denialSpike && (
                  <Warning className="inline w-3 h-3 ml-1 text-red-400" />
                )}
              </span>
            </div>
          </div>
