...
export PYTHONPATH="./apps/api:./packages/sardis-core/src:./packages/sardis-wallet/src:./packages/sardis-chain/src:./packages/sardis-protocol/src:./packages/sardis-cards/src:./packages/sardis-compliance/src:./packages/sardis-ledger/src:./packages/sardis-checkout/src:$PYTHONPATH"
...
# Run with uv
uv run uvicorn --app-dir apps/api server.main:create_app --factory --host 0.0.0.0 --port 8000 --reload
