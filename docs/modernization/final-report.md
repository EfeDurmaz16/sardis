...
- Continue physical route placement cleanup by moving compliance and evidence surfaces into domain packages with temporary compatibility wrappers or aliases.
