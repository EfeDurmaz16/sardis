...
- `python3 -m compileall -q packages/sardis-api/src/sardis_api/routes/agents packages/sardis-api/src/sardis_api/routers/agent_activity.py packages/sardis-api/src/sardis_api/routers/agent_events.py packages/sardis-api/src/sardis_api/routers/agent_heartbeat.py packages/sardis-api/src/sardis_api/main.py` passed after moving agent lifecycle routes.
