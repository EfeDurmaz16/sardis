...
- Evidence: `packages/server-api/alembic/versions/001_initial_schema.py` through `030_facility_gate.py`; raw SQL migrations continue through `packages/server-api/migrations/106_agent_registry.sql`.
