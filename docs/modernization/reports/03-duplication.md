...
- Evidence: `packages/api/alembic/versions/001_initial_schema.py` through `030_facility_gate.py`; raw SQL migrations continue through `packages/api/migrations/106_agent_registry.sql`.
