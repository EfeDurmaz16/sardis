...
- Evidence: `apps/api/server/routes/` contains well over 100 route modules, and `main.py` registers many under `/api/v2`.
...
- Evidence: `apps/api/openapi/` contains ChatGPT action and README artifacts; API app has `openapi_schema.py`.
