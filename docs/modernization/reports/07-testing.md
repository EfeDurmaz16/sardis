...
- Evidence: local traversal found `packages/sardis-api/.venv`, `.pytest_cache`, `.ruff_cache`, `.next`, and other build folders. They are ignored, but scripts using plain `find` can still traverse them.
