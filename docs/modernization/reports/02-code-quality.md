...
- Evidence: `packages/server-api/src/sardis_server/main.py` configures telemetry, security middleware, rate limiting, TAP, x402, usage metering, repository construction, dozens of router overrides, checkout, merchant, billing, facility, sandbox, and health behavior.
