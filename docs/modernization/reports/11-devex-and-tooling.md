...
- Evidence: root README and docs-site quickstarts reference `from sardis import Sardis`, while `sardis/__init__.py` exports `SardisClient` and `AsyncSardisClient`.
